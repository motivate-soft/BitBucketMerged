...
const config = {
  ...
  plugins: [
    new webpack.DefinePlugin(Object.assign({
      ...
      __KE_URL_HOME__: JSON.stringify('https://mcbotkaraoke.com'),
      __KE_URL_LICENSE__: JSON.stringify('/licenses.txt'),
      __KE_URL_REPO__: JSON.stringify('https://mcbotkaraoke.com/repo'),
      __KE_URL_SPONSOR__: JSON.stringify('https://mcbotkaraoke.com/sponsor'),
